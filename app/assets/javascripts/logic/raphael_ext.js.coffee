...
Raphael.fn.connection = (start, end, line, bg, strokeWidth, backgroundStrokeWidth) ->
  if start.line and start.from and start.to
    connection = start
    obj1 = connection.from.el
    obj2 = connection.to.el
    obj2 ||= connection.to
  else
    obj1 = start.el
    obj2 = end.el
  ...
  if obj1 and obj2
    ...
    if connection and connection.line
      connection.bg and connection.bg.attr(path: path)
      connection.line.attr path: path
      connection.target.attr path: path
    else
